...
![](https://quarto.org/docs/get-started/hello/images/rstudio-source-visual.png){.fragment fig-alt="A screenshot of a Quarto document interface inside RStudio" fig-align="center" width="600"}
...
![](images/background-job.png){fig-align="center" width="600"}
...
![](https://quarto.org/docs/tools/images/rstudio-preview.png){.fragment fig-alt="A screenshot of a Quarto document rendered inside RStudio" fig-align="center" width="600"}
